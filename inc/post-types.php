			...
			<div id="cptui_panel_pt_basic_settings" class="cptui-section postbox">
				...
				<div class="inside">
					<div class="main">
						...
						echo $ui->get_label( 'name', 'Post Type Slug' ); // phpcs:ignore.
						echo $ui->get_required_span(); // phpcs:ignore.

						if ( 'edit' === $tab ) {
							echo '<p id="slugchanged" class="hidemessage">' . 'Slug has changed' . '<span class="dashicons dashicons-warning"></span></p>';
						}
						echo '<p id="slugexists" class="hidemessage">' . 'Slug already exists' . '<span class="dashicons dashicons-warning"></span></p>';
						...
						echo $ui->get_text_input( // phpcs:ignore.
							[
								...
								'maxlength'   => '20',
								'helptext'    => esc_html__( 'The post type name/slug. Used for various queries for post type content.', 'custom-posts-type-ui' ),
								'required'    => true,
								'placeholder' => false,
								'wrap'        => false,
							]
						...
						echo '<p class="cptui-slug-details">';
							echo 'Slugs may only contain lowercase alphanumeric characters, dashes, and underscores.';
						echo '</p>';
